...
int main()
{
	...
	cout<<"The content of c using a is:"<<c<<endl;
	cout<<"The content of c inside pointer a1 using pointer p1 is\t"<<*p1<<endl;
...
The content of b inside  using pointer p2 is    13046608
**********
The address of a by using a is:0x6ffdfc
The address of a by using pointer p is:0x6ffdfc
The content of a using a is:20
The content of a inside pointer a1 using pointer p1 is  20
The address of c by using a is:0x6ffdf8
The address of c by using pointer p is:0x6ffdf8
The content of c using a is:50
The content of c inside pointer a1 using pointer p1 is  50
*/
